        ...
        return (
          <div key={step.id} className="flex gap-3">
            <div className="flex flex-col items-center">
              <div
                className={`relative flex size-5 shrink-0 items-center justify-center rounded-full border ${
                  state === 'done'
              ...
              >
                {state === 'active' && (
                  <span className="absolute inset-0 rounded-full border border-primary animate-sonar" />
                )}
                {state === 'done' ? (
...
export function ConnectionLog({ logs = [] }) {
  ...
  return (
    <div className="max-h-44 w-full max-w-xl overflow-y-auto rounded-md border border-white/10 bg-black/40 p-3 text-left font-mono text-[11px] leading-relaxed">
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-5 px-6 text-center">
      <div className="relative flex size-16 items-center justify-center">
        <span className="absolute inset-0 rounded-full border border-primary/40 animate-sonar" />
        <span className="absolute inset-0 rounded-full border border-primary/40 animate-sonar [animation-delay:0.9s]" />
